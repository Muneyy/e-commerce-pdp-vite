    ...
    <div className="details-container">
      ...
      <div className="details-cart-quantity">
        <div className="details-quantity">
          <button type="button" className="quantity-decrease" aria-label="decrease quantity">
          ...
          <p>{quantity}</p>
          <button type="button" className="quantity-decrease" aria-label="increase quantity">
